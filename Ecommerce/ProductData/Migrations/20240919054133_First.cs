    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Attribut__C189298A6FAD22B7", x => x.AttributeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__19093A2BF423BE19", x => x.CategoryID);
                    table.ForeignKey(
                        name: "FK__Categorie__Paren__37A5467C",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderSta__C8EE20430337321D", x => x.StatusID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6EDE5205D84", x => x.ProductID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Attribut__335E225694CE0387", x => x.AttributeValueID);
                    table.ForeignKey(
                        name: "FK__Attribute__Attri__3C69FB99",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__C3905BAFB1041631", x => x.OrderID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Warehous__2608AFD9AADA574F", x => x.WarehouseID);
                    table.ForeignKey(
                        name: "FK__Warehouse__Produ__45F365D3",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderIte__57ED06A1EED0988D", x => x.OrderItemID);
                    table.ForeignKey(
                        name: "FK__OrderItem__Order__5165187F",
                        column: x => x.OrderID,
