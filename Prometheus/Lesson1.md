...
`Nagios` – это система мониторинга, которая позволяет контролировать состояние компьютерной сети и оповещать администратора о возникших проблемах. Основными возможностями Nagios являются:
- мониторинг сетевых ресурсов (серверов, коммутаторов, маршрутизаторов и т.д.);
- мониторинг сервисов (SMTP, POP3, HTTP, NNTP, PING и т.д.);
- мониторинг хостов (нагрузка процессора, использование памяти, дисковое пространство и т.д.);
